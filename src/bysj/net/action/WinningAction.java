...
public class WinningAction extends ActionSupport {
	private Winning util;
	private PageModel<Winning> pageModel;
	...
	public String selectUtil() throws Exception{
		listUser = objectManager.getUtil("from User");
		util = (Winning) objectManager.getObject(new Winning(), util.getId());
		return "saveOrUpdate";
	}
	...
	public Winning getUtil() {
		return util;
	}

	public void setUtil(Winning util) {
		this.util = util;
	}
	...
	public PageModel<Winning> getPageModel() {
		return pageModel;
	}

	public void setPageModel(PageModel<Winning> pageModel) {
