...
public class FruitAction extends ActionSupport {
	private Fruit util;
	private PageModel<Fruit> pageModel;
	private List<User> listUser;
	private List<Scientific> listScientific;
	...
	public String initUtil() throws Exception{
		...
		listScientific = objectManager.getUtil("from Scientific");
		util = null;
		return "saveOrUpdate";
	}
	...
	public String selectUtil() throws Exception{
		listUser = objectManager.getUtil("from User");
		listScientific = objectManager.getUtil("from Scientific");
		util = (Fruit) objectManager.getObject(new Fruit(), util.getId());
		return "saveOrUpdate";
	}
	...
	public Fruit getUtil() {
		return util;
	}

	public void setUtil(Fruit util) {
		this.util = util;
	}
	...
	public PageModel<Fruit> getPageModel() {
		return pageModel;
	}

	public void setPageModel(PageModel<Fruit> pageModel) {
	...
	public List<Scientific> getListScientific() {
		return listScientific;
	}

	public void setListScientific(List<Scientific> listScientific) {
		this.listScientific = listScientific;
	}
