...
public class PaperAction extends ActionSupport {
	private Paper util;
	private PageModel<Paper> pageModel;
	...
	public String selectUtil() throws Exception{
		listUser = objectManager.getUtil("from User");
		util = (Paper) objectManager.getObject(new Paper(), util.getId());
		return "saveOrUpdate";
	}
	...
	public Paper getUtil() {
		return util;
	}

	public void setUtil(Paper util) {
		this.util = util;
	}
	...
	public PageModel<Paper> getPageModel() {
		return pageModel;
	}

	public void setPageModel(PageModel<Paper> pageModel) {
