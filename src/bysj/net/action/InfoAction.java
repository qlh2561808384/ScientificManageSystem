...
public class InfoAction extends ActionSupport {
	private Info util;
	private PageModel<Info> pageModel;
	...
	public String selectUtil() throws Exception{
		listUser = objectManager.getUtil("from User");
		util = (Info) objectManager.getObject(new Info(), util.getId());
		return "saveOrUpdate";
	}
	...
	public PageModel<Info> getPageModel() {
		return pageModel;
	}

	public void setPageModel(PageModel<Info> pageModel) {
