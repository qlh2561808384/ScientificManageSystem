...
<html>
	...
	<body>
		...
		<div class="formbody">
		<form
			action="${pageContext.request.contextPath}/Fruit-saveOrUpdateObject.action"
			...
			<table
				...
				<tbody>
					<tr>
						...
						<td >
							<select class="select2"  name="util.scientific.id">
								<c:forEach var="type" items="${listScientific}">
									<option
										<c:if test="${type.id == util.scientific.id }">
																	selected
																	</c:if>
										value="${type.id }">
										${type.s_0 }
